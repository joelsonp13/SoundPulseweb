...
```bash
pip install -U ytmusicapi flask
...
### 3. **YouTube IFrame API Pode Bloquear Alguns Vídeos**
- Alguns vídeos podem dar erro 150/101 (embedding disabled)
- O player simplesmente para a reprodução (comportamento padrão)
- Não há fallback implementado
